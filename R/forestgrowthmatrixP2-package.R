#' forestgrowthmatrixP2: Matrix Model for Forest Biomass Projection
#'
#' The forestgrowthmatrixP2 package provides functions for projecting forest biomass
...
#'
#' @docType package
#' @name forestgrowthmatrixP2
#' @aliases forestgrowthmatrixP2-package
#'
